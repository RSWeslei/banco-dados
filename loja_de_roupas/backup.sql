...
-- Started on 2022-07-01 17:57:01 -03
...
CREATE VIEW public.vw_aniversariantes AS
 SELECT c.nome,
  ...
  WHERE ((EXTRACT(day FROM c.nascimento) = EXTRACT(day FROM now())) AND (EXTRACT(month FROM c.nascimento) = EXTRACT(month FROM now())));
...
--
-- TOC entry 229 (class 1259 OID 18591)
...
--
-- TOC entry 225 (class 1259 OID 18572)
...
-- Completed on 2022-07-01 17:57:01 -03
